        ...
        for ( var i = 2; i <= maxValue; i++ ) {
            ...
            if(document.getElementById(rowid).style.display == 'none') {
                ...
                if(type == 'discount' ) {
                    ...
                    var j = i -1;
                    var element_date = cj('#discount_end_date_' + j ).val( );
                    var discount_date= new Date( element_date );
                    discount_date.setDate( discount_date.getDate() + 1 );
                    //FIXME date doesn't set for the format having in prefrences
                    if ( element_date ) {
                        cj('#discount_start_date_' + i ).val( discount_date.toDateString( ) );
                    }
        ...
        for (var i = 2; i <= maxValue; i++ ) {
            ...
            if(document.getElementById(rowid).style.display == 'none') {
                ...
                if (i <= maxValue && type == 'discount') {
                    ...
                    var discount_date = new Date( element_date );
                    discount_date.setDate( discount_date.getDate() + 1 );
                    discount_date.setMonth( discount_date.getMonth() + 1 );
                    //FIXME date doesn't set for the format having in prefrences
                    if ( element_date ) {
                        cj('#discount_start_date_' + i ).val( discount_date.toDateString( ) );
                    }
