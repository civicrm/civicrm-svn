...
INSERT INTO `civicrm_dashboard` 
    ( `domain_id`, `label`, `url`, `permission`, `permission_operator`, `column_no`, `is_minimized`, `is_active`, `weight`, `is_fullscreen`) 
    VALUES 
    ( @domain_id, '{ts escape="sql"}Donor Report (Summary){/ts}'       , 'civicrm/report/instance/3&reset=1&section=1&snippet=4&charts=barChart',  'access CiviCRM,access CiviContribute', 'AND', 0, 0,'1', 4, 0),
    ( @domain_id, '{ts escape="sql"}Top Donors Report{/ts}'            , 'civicrm/report/instance/20&reset=1&section=2&snippet=4',                 'access CiviCRM,access CiviContribute', 'AND', 0, 0,'1', 5, 1),
    ( @domain_id, '{ts escape="sql"}Event Income Report (Summary){/ts}', 'civicrm/report/instance/13&reset=1&section=1&snippet=4&charts=pieChart', 'access CiviCRM,access CiviEvent'     , 'AND', 0, 0,'1', 6, 0),
    ( @domain_id, '{ts escape="sql"}Membership Report (Summary){/ts}'  , 'civicrm/report/instance/9&reset=1&section=2&snippet=4',                  'access CiviCRM,access CiviMember'    , 'AND', 0, 0,'1', 7, 1);
