...
INSERT INTO `civicrm_dashboard` 
    ...
    VALUES 
    ( @domain_id, '{ts escape="sql"}Donor Report (Summary){/ts}'       , 'civicrm/report/instance/6&reset=1&section=1&snippet=4&charts=barChart',  'access CiviContribute', 'AND', 0, 0,'1', 4, '1', 'civicrm/report/instance/6&reset=1&section=1&snippet=4&charts=barChart&context=dashletFullscreen'),
    ( @domain_id, '{ts escape="sql"}Top Donors Report{/ts}'            , 'civicrm/report/instance/13&reset=1&section=2&snippet=4',                 'access CiviContribute', 'AND', 0, 0,'1', 5, '1', 'civicrm/report/instance/13&reset=1&section=2&snippet=4&context=dashletFullscreen'),
    ( @domain_id, '{ts escape="sql"}Event Income Report (Summary){/ts}', 'civicrm/report/instance/23&reset=1&section=1&snippet=4&charts=pieChart', 'access CiviEvent'     , 'AND', 0, 0,'1', 6, '1', 'civicrm/report/instance/23&reset=1&section=1&snippet=4&charts=pieChart&context=dashletFullscreen'),
    ( @domain_id, '{ts escape="sql"}Membership Report (Summary){/ts}'  , 'civicrm/report/instance/19&reset=1&section=2&snippet=4',                 'access CiviMember'    , 'AND', 0, 0,'1', 7, '1', 'civicrm/report/instance/19&reset=1&section=2&snippet=4&context=dashletFullscreen');
