...
VALUES    
    ...
    ( @domainID, 'civicrm/campaign/gotv&reset=1', '{ts escape="sql"}Respondent Listing{/ts}', 'Respondent Listing', 'administer CiviCampaign,manage campaign,release campaign contacts', 'OR', @campaignlastID, '1', NULL, 8 ),
