...
-- event name badges
  ...
  (@option_group_id_eventBadge , '{ts escape="sql"}With Logo{/ts}'i   , 3, 'CRM_Event_Badge_Logo', NULL, 0, 0, 3, '{ts escape="sql"}You can set your own background image/ts}',  0, 1, 1, NULL, NULL );
