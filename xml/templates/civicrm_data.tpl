...
-- report templates
  ...
  (@option_group_id_report, {localize}'{ts escape="sql"}Contribution details for any type of contribution, plus associated membership information for contributions which are in payment for memberships.{/ts}'{/localize}, 'contribute/membershipDetail', 'CRM_Report_Form_Contribute_MembershipDetail', NULL, 0, NULL, 48, {localize}'{ts escape="sql"}Contribution and Membership Details{/ts}'{/localize}, 0, 0, 1, @contributeCompId, NULL),
