...
-- report templates
  ...
  (@option_group_id_report, {localize}'{ts escape="sql"}Survey Report (Detail){/ts}'{/localize},    'survey/detail', 'CRM_Report_Form_Campaign_SurveyDetails',  NULL, 0, NULL, 41, {localize}'{ts escape="sql"}Detailed report for canvassing, phone-banking, walk lists or other surveys.{/ts}'{/localize}, 0, 0, 1, @campaignCompId, NULL),
(@option_group_id_report, {localize}'{ts escape="sql"}Personal Campaign Page Report{/ts}'{/localize},    'contribute/pcp', 'CRM_Report_Form_Contribute_PCP',  NULL, 0, NULL, 42, {localize}'{ts escape="sql"}Shows Personal Campaign Page Report{/ts}'{/localize}, 0, 0, 1, 2, NULL),
