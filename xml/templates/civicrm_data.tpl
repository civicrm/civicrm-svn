...
VALUES 
    ( @domainID, 'Hourly' , NULL, '{ts escape="sql" skip="true"}Send Scheduled Mailings{/ts}',      '{ts escape="sql" skip="true"}Sends out scheduled CiviMail mailings{/ts}',                                                       'civicrm_api3', 'job', 'process_mailing',         'version=3\r\n', 0),
    ( @domainID, 'Hourly' , NULL, '{ts escape="sql" skip="true"}Fetch Bounces{/ts}',                '{ts escape="sql" skip="true"}Fetches bounces from mailings and writes them to mailing statistics{/ts}',                         'civicrm_api3', 'job', 'fetch_bounces',           'version=3\r\n', 0),
    ( @domainID, 'Hourly' , NULL, '{ts escape="sql" skip="true"}Process Inbound Emails{/ts}',       '{ts escape="sql" skip="true"}nserts activity for a contact or a case by retrieving inbound emails from a mail directory{/ts}',  'civicrm_api3', 'job', 'fetch_activities',        'version=3\r\n', 0),
