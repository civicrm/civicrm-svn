...
VALUES 
    ...
    ( @domainID, 'Always' , NULL, '{ts escape="sql" skip="true"}Membership reminder date processor{/ts}','{ts escape="sql" skip="true"}Sets membership renewal reminder dates for current membership records where this date has not been set{/ts}','civicrm_api3', 'job', 'process_membership_reminder_date',     'version=3\r\n', 0);
