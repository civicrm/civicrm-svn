...
-- report templates
  ...
  (@option_group_id_report, {localize}'{ts escape="sql"}Walk List Survey Report{/ts}'{/localize},    'walklist/survey', 'CRM_Report_Form_Walklist_Survey',  NULL, 0, NULL, 41, {localize}'{ts escape="sql"}Provides a detailed report for your walk list survey{/ts}'{/localize}, 0, 0, 1, @campaignCompId, NULL),
