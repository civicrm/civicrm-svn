...
INSERT INTO civicrm_uf_field
       ...
       (36,  9,           'phone',                 1,           0,           1,      'User and User Admin Only',  0,           0,             3,             '{ts escape="sql"}Phone (Main) {/ts}',                  'Contact',    NULL,   NULL),
       (37,  9,           'email',                 1,           0,           1,      'User and User Admin Only',  0,           0,             3,             '{ts escape="sql"}Email (Main) {/ts}',                  'Contact',    NULL,   NULL),
       (38,  9,           'street_address',        1,           0,           1,      'User and User Admin Only',  0,           0,             3,             '{ts escape="sql"}Street Address{/ts}',                 'Contact',    NULL,   NULL),
       (39,  9,           'city',                  1,           0,           1,      'User and User Admin Only',  0,           0,             3,             '{ts escape="sql"}City{/ts}',                           'Contact',    NULL,   NULL),
       (40,  9,           'postal_code',           1,           0,           1,      'User and User Admin Only',  0,           0,             3,             '{ts escape="sql"}Postal Code{/ts}',                    'Contact',    NULL,   NULL),
       (41,  9,           'country',               1,           0,           1,      'User and User Admin Only',  0,           0,             3,             '{ts escape="sql"}Country{/ts}',                        'Contact',    NULL,   NULL),
       (42,  9,           'state_province',        1,           0,           1,      'User and User Admin Only',  0,           0,             3,             '{ts escape="sql"}State / Province{/ts}',               'Contact',    NULL,   NULL);
