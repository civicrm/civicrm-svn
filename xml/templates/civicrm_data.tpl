...
INSERT INTO civicrm_dedupe_rule_group (contact_type, threshold, level, is_default, used, name, title, is_reserved)
VALUES ('Individual', 20, 'Fuzzy', 1, 'Supervised', 'IndividualFuzzy', '{ts escape="sql"}Individual Fuzzy In-built{/ts}', 1);
...
INSERT INTO civicrm_dedupe_rule_group (contact_type, threshold, level, is_default, used, name, title, is_reserved)
VALUES ('Organization', 10, 'Fuzzy', 1, 'Supervised', 'OrganizationFuzzy', '{ts escape="sql"}Organization Fuzzy{/ts}', 0);
...
INSERT INTO civicrm_dedupe_rule_group (contact_type, threshold, level, is_default, used, name, title, is_reserved)
VALUES ('Household', 10, 'Fuzzy', 1, 'Supervised', 'HouseholdFuzzy', '{ts escape="sql"}Household Fuzzy{/ts}', 0);
...
INSERT INTO civicrm_dedupe_rule_group (contact_type, threshold, level, is_default, used, name, title, is_reserved)
VALUES ('Individual', 10, 'Strict', 1, 'Unsupervised', 'IndividualStrict', '{ts escape="sql"}Individual Strict In-built{/ts}', 1);
...
INSERT INTO civicrm_dedupe_rule_group (contact_type, threshold, level, is_default, used, name, title, is_reserved)
VALUES ('Organization', 10, 'Strict', 1, 'Unsupervised', 'OrganizationStrict', '{ts escape="sql"}Organization Strict{/ts}', 0);
...
INSERT INTO civicrm_dedupe_rule_group (contact_type, threshold, level, is_default, used, name, title, is_reserved)
VALUES ('Household', 10, 'Strict', 1, 'Unsupervised', 'HouseholdStrict', '{ts escape="sql"}Household Strict{/ts}', 0);
...
INSERT INTO civicrm_dedupe_rule_group (contact_type, threshold, level, is_default, used, name, title, is_reserved)
VALUES ('Individual', 15, 'Strict', 0, 'General', 'IndividualComplete', '{ts escape="sql"}Individual Complete Inbuilt{/ts}', 1);
...
VALUES
    ...
    ( @domainID, 'Hourly' , NULL, '{ts escape="sql" skip="true"}Process Inbound Emails{/ts}',       '{ts escape="sql" skip="true"}Inserts activity for a contact or a case by retrieving inbound emails from a mail directory{/ts}',  'civicrm_api3', 'job', 'fetch_activities',        NULL, 0),
    ( @domainID, 'Daily' ,  NULL, '{ts escape="sql" skip="true"}Process Pledges{/ts}',              '{ts escape="sql" skip="true"}Updates pledge records and sends out reminders{/ts}',                                              'civicrm_api3', 'job', 'process_pledge','{ts escape="sql" skip="true"}send_reminders=[1 or 0] optional- 1 to send payment reminders{/ts}', 0),
    ( @domainID, 'Daily' ,  NULL, '{ts escape="sql" skip="true"}Geocode and Parse Addresses{/ts}',  '{ts escape="sql" skip="true"}Retrieves geocodes (lat and long) and / or parses street addresses (populates street number, street name, etc.){/ts}','civicrm_api3', 'job', 'geocode', '{ts escape="sql" skip="true"}geocoding=[1 or 0] required
...
throttle=[1 or 0] optional-1 adds five second sleep{/ts}', 0),
    ( @domainID, 'Daily' ,  NULL, '{ts escape="sql" skip="true"}Update Greetings and Addressees{/ts}','{ts escape="sql" skip="true"}Goes through contact records and updates email and postal greetings, or addressee value{/ts}',   'civicrm_api3', 'job', 'update_greeting','{ts escape="sql" skip="true"}ct=[Individual or Household or Organization] required
...
force=[0 or 1] optional-0 update contacts with null value, 1 update all{/ts}', 0),
    ( @domainID, 'Daily' ,  NULL, '{ts escape="sql" skip="true"}Mail Reports{/ts}', '{ts escape="sql" skip="true"}Generates and sends out reports via email{/ts}', 'civicrm_api3', 'job', 'mail_report','{ts escape="sql" skip="true"}instanceId=[ID of report instance] required
format=[csv or print] optional-output CSV or print-friendly HTML, else PDF{/ts}', 0),
    ...
    ( @domainID, 'Daily' , NULL, '{ts escape="sql" skip="true"}Update Membership Statuses{/ts}', '{ts escape="sql" skip="true"}Updates membership statuses. WARNING: Membership renewal reminders have been migrated to the Schedule Reminders functionality, which supports multiple renewal reminders.{/ts}', 'civicrm_api3', 'job', 'process_membership',   NULL, 0),
