...
///////////////// civicrm_event_search methods
    ...
    function testEventCreationPermissions()
    {
        ...
        $params = array('event_type_id' => 1, 'start_date' => '2010-10-03', 'title' => 'le cake is a tie');
        ...
        $this->assertEquals('API permission check failed for civicrm_event_create call.', $result['error_message'], 'lacking permissions should not be enough to create an event');
