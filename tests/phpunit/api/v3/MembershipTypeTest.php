...
class api_v3_MembershipTypeTest extends CiviUnitTestCase
{
  ...
  function testCreateWithEmptyParams()
  {
      ...
      $this->assertEquals( $membershiptype['error_message'],
                           'Mandatory key(s) missing from params array: domain_id, member_of_contact_id, financial_account_id, duration_unit, duration_interval, name');
  }
  ...
  function testUpdateWithEmptyParams()
  {
      ...
      $this->assertEquals( $membershiptype['is_error'], 1 );
      $this->assertEquals( $membershiptype['error_message'],
                           'Mandatory key(s) missing from params array: version, domain_id, member_of_contact_id, financial_account_id, duration_unit, duration_interval, name');
  }
