...
class api_v3_ContactTest extends CiviUnitTestCase
{
  ...
  function testCreateIndividualWithNameEmailLocationType()
  {
    ...
    $this->assertEquals( 1, $result['contact_id'], "In line " . __LINE__ );
  ...
  */
  ...
  public function testContactGetRetFirst()
  {
    ...
    $this->assertEquals( 2, count( $result[17] ), "In line " . __LINE__ );
    $this->assertEquals( 17, $result[17]['contact_id'], "In line " . __LINE__ );
    $this->assertEquals( 'Test', $result[17]['first_name'] , "In line " . __LINE__);
  }
