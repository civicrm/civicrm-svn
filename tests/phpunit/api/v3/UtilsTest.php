...
class api_v3_UtilsTest extends CiviUnitTestCase {
    ...
    function testCheckPermissionReturn() {
        ...
        $this->assertFalse(civicrm_api3_api_check_permission('civicrm_api3_contact_create', $check, false), 'empty permissions should not be enough');
        CRM_Core_Permission_UnitTests::$permissions = array ('access CiviCRM' );
        $this->assertFalse(civicrm_api3_api_check_permission('civicrm_api3_contact_create', $check, false), 'lacking permissions should not be enough');
        ...
        $this->assertTrue(civicrm_api3_api_check_permission('civicrm_api3_contact_create', $check, false), 'exact permissions should be enough');

        CRM_Core_Permission_UnitTests::$permissions = array ('access CiviCRM', 'add contacts', 'import contacts' );
        $this->assertTrue(civicrm_api3_api_check_permission('civicrm_api3_contact_create', $check, false), 'overfluous permissions should be enough');
    }
    ...
    function testCheckPermissionThrow() {
        ...
        try {
            CRM_Core_Permission_UnitTests::$permissions = array ('access CiviCRM' );
            civicrm_api3_api_check_permission('civicrm_api3_contact_create', $check);
        } catch ( Exception $e ) {
        ...
        CRM_Core_Permission_UnitTests::$permissions = array ('access CiviCRM', 'add contacts', 'import contacts' );
        $this->assertTrue(civicrm_api3_api_check_permission('civicrm_api3_contact_create', $check), 'overfluous permissions should return true');
    }

    function testCheckPermissionSkip() {
        CRM_Core_Permission_UnitTests::$permissions = array ('access CiviCRM' );
        $this->assertFalse(civicrm_api3_api_check_permission('civicrm_api3_contact_create', array('check_permissions' => true), false), 'lacking permissions should not be enough');
        $this->assertTrue(civicrm_api3_api_check_permission('civicrm_api3_contact_create', array('check_permissions' => false), false), 'permission check should be skippable');
    }
