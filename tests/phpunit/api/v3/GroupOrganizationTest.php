...
class api_v3_GroupOrganizationTest extends CiviUnitTestCase
{
    ...
    {
        $params = 'delete';
        $result =& civicrm_api3_group_organization_delete($params);
    ...
    {   
        ...
        $result =& civicrm_api3_group_organization_create( $paramsC );
    ...
    {   
        $paramsDelete = array( 'invalid_key' => 1,
                                'version'   => $this->_apiversion, );
        $result =& civicrm_api3_group_organization_delete( $paramsDelete );
