...
class WebTest_Event_MultiprofileEventTest extends CiviSeleniumTestCase {
    ...
    function _testRemoveProfile( $eventPageId )
    {
        ...
        $this->select("custom_post_id_multiple_1" , "value=");
        $this->select("custom_post_id_multiple_2" , "value=");
    ...
    function _testAddMultipleProfile( $profileId )
    {
        ...
        $this->waitForElementPresent("xpath=//div[@id='registration_screen']/fieldset/table//tbody/tr[7]/td[2]/span/a[text()='add profile']" );
        $this->click( "xpath=//div[@id='registration_screen']/fieldset/table//tbody/tr[7]/td[2]/span/a[text()='add profile']" );
