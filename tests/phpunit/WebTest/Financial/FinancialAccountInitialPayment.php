 ...
 function testContributeOnlineWithPriceSet()
  {
      ...
      //   $this->verifyText("xpath=id('ContributionView')/div[2]/table[1]/tbody/tr[2]/td[2]", preg_quote($financialType['name']));
...
function testAddPriceSet()
{
 ...
 function testContributeDistributeEvenly(){
   // This is the path where our testing install resides. 
   // The rest of URL is defined in CiviSeleniumTestCase base class, in
   // class attributes.
   $this->open( $this->sboxPath );
 ...
 function testContributeSingleAllocate(){
    // This is the path where our testing install resides. 
    // The rest of URL is defined in CiviSeleniumTestCase base class, in
    // class attributes.
    $this->open( $this->sboxPath );
 ...
 function testContributeDoubleAllocate(){
    // This is the path where our testing install resides. 
    // The rest of URL is defined in CiviSeleniumTestCase base class, in
    // class attributes.
    $this->open( $this->sboxPath );
