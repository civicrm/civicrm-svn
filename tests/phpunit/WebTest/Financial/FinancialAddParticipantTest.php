...
class WebTest_Financial_FinancialAddParticipantTest extends CiviSeleniumTestCase {
  ...
  function testOfflineEventParticipationAdd() {
    ...
    $contribId = $valueID[1];
    $lineItem = CRM_Price_BAO_LineItem::getLineItems($contribId, 'contribution', 1);
    $url = $this->click ("xpath=//form[@id='Participant']/div[2]/div/table[2]/tbody/tr/td[8]/span/a[text()='Edit']"); 
    $this->_testLineItem( $lineItem);

  }


  function testEvenlyDistribute() {
    ...
    $this->click("xpath=//input[@class='form-radio']");
    $this->click("xpath=//input[@class='form-checkbox']");
    $this->fireEvent("xpath=//input[@class='form-text four required']", 'blur');  
    sleep(5);
    // Choose Registration Date.
    // Using helper webtestFillDate function.
    $this->webtestFillDate('register_date', 'now');
    ...
    $contribId = $valueID[1];
    $lineItem = CRM_Price_BAO_LineItem::getLineItems($contribId, 'contribution', 1);
    $this->click ("xpath=//form[@id='Participant']/div[2]/div/table[2]/tbody/tr/td[8]/span/a[text()='Edit']"); 
    $this->_testLineItem( $lineItem);
