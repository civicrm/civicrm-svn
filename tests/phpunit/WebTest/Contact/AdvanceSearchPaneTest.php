  ...
  function _advanceSearchPanes( $paneRef = null ) {
      ...
      if ( !isset($_advance_search_panes) || empty($_advance_search_panes) ) {
          $_advance_search_panes = 
              array( 'location' => 
                     array( 'headerLocator' => 'div#location',
                     ...
                     'custom' => 
                     array( 'headerLocator' => 'div#custom',
                     ...
                     'activity' => 
                     array( 'headerLocator' => 'div#activity',
                     ...
                     'relationship' => 
                     array( 'headerLocator' => 'div#relationship',
                     ...
                     'demographics' => 
                     array( 'headerLocator' => 'div#demographics',
                            'bodyLocator'   => 'input#birth_date_low_display',
                            'title'         => 'Demographics',
                            'fields'        => 
                            array( 'Birth Date from'   => 
                                   array( 'type'    => 'date',
                     ...
                     'change_log' => 
                     array( 'headerLocator' => 'div#changeLog',
                     ...
                     'contribution' => 
                     array( 'headerLocator' => 'div#CiviContribute',
                            'bodyLocator'   => 'select#financial_account_id',
                            'title'         => 'Contributions',
                            'fields'        => 
                            array( 'Amount from'   => 
                                   array( 'type'    => 'text',
                     ...
                     'membership' => 
                     array( 'headerLocator' => 'div#CiviMember',
                            'bodyLocator'   => 'input#member_source',
                            'title'         => 'Memberships',
                            'fields'        => 
                            array( 'Membership Type' =>
                                   array( 'type'   => 'checkbox',
                     ...
                     'event' => 
                     array( 'headerLocator' => 'div#CiviEvent',
                            'bodyLocator'   => 'input#event_name',
                            'title'         => 'Events',
                            'fields'        => 
                            array( 'Participant Status' =>
                                   array( 'type'   => 'checkbox',
