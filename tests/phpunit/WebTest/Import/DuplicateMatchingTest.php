...
class WebTest_Import_DuplicateMatchingTest extends ImportCiviSeleniumTestCase {
  ...
  {  
      ...
      $existingContact = array( 'first_name' => $firstName,
                                'last_name'  => $lastName,
                                'email'      => $email );
      ...
      $updateHeaders = array( 'email'      => 'Email',
      ...
      foreach ( $importedContactIds as $cid ) {
          $updateRows[$cid] = array( 'email'      => $contact['email'],
      ...
      $fillRows = array( );
      foreach ( $importedContactIds as $cid ) {
          $fillRows[$cid] = array( 'email'      => $updateRows[$cid]['email'],
  ...
  function testOrganizationDuplicateMatchingImport()
  {
      ...
      $organizationFields = array( 'organization_name' => $organizationName,
  ...
  function testHouseholdDuplicateMatchingImport() 
  {
      ...
      $householdFields = array( 'household_name' => $householdName,
  ...
  function checkDuplicateContacts( $originalHeaders, $originalRows, $checkSummary ) 
  {
      ...
      $checkSummary = array( 'Total Rows'               => '2',
                             'Duplicate Rows'           => '1',
                             'Total Contacts'           => '1',
                             );
