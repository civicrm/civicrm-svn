...
INSERT INTO `civicrm_action_schedule` (`id`, `name`, `title`, `recipient`, `entity_value`, `entity_status`, `start_action_offset`, `start_action_unit`, `start_action_condition`, `is_repeat`, `repetition_frequency_unit`, `repetition_frequency_interval`, `end_frequency_unit`, `end_frequency_interval`, `end_action`, `is_active`, `recipient_manual`, `body_text`, `body_html`, `subject`, `record_activity`, `mapping_id`, `group_id`) VALUES
