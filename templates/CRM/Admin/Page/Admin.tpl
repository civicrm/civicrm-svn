...
{if $newVersion}
    <div class="messages status">
        ...
        <div class="messages status">
        <table><tr><td class="tasklist">
         {ts 1='http://civicrm.org/civicrm/profile/create?reset=1&gid=15'}
            Have you registered this site at CiviCRM.org? If not, please help strengthen the CiviCRM ecosystem by taking
            a few minutes to <a href="%1">fill out the site registration form</a>. The information collected will help us
            prioritize improvements, target our communications and build the community. If you have a technical role for this
            site, be sure to check "Keep in Touch" to receive technical updates (a low volume mailing list).
        {/ts}</td></tr></table>
        </div>
    </div>
{/if}
