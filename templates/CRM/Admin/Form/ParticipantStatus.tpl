  ...
  <fieldset>
    ...
    {else}
      <table class="form-layout-compressed">
        ...
        <tr class="crm-participant-form-block-is_reserved">
           <td class="label">{$form.is_reserved.label}</td>
           <td>{$form.is_reserved.html}</td>
        </tr>
        <tr class="crm-participant-form-block-is_active">
           <td class="label">{$form.is_active.label}</td>
           <td>{$form.is_active.html}</td>
        </tr>
        <tr class="crm-participant-form-block-is_counted">
        ...
        <tr class="crm-participant-form-block-weight">
           <td class="label">{$form.weight.label}</td>
           <td>{$form.weight.html}</td>
        </tr>

        <tr class="crm-participant-form-block-visibility_id">
