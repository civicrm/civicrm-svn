...
<div class="crm-block crm-form-block crm-relationship_type-form-block">
	...
	{if $action eq 8}
     ...
     {else}
	    <table class="form-layout-compressed">
            <tr class="crm-relationship_type-form-block-label_a_b">
            ...
            <tr class="crm-relationship_type-form-block-label_b_a">
            ...
            <tr class="crm-relationship_type-form-block-contact_types_a">
                <td class="label">{$form.contact_types_a.label}</td>
                <td>{$form.contact_types_a.html}</td>
            </tr>
            <tr class="crm-relationship_type-form-block-contact_types_b">
                <td class="label">{$form.contact_types_b.label}</td>
                <td>{$form.contact_types_b.html}</td>
            </tr>
            <tr class="crm-relationship_type-form-block-description">
                <td class="label">{$form.description.label}</td>
                <td>{$form.description.html}</td>
            </tr>
            <tr class="crm-relationship_type-form-block-is_active">
