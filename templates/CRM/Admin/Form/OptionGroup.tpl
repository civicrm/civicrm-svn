...
<div class="crm-block crm-form-block crm-option_group-form-block">
   ...
   {if $action eq 8}
     ...
     {else}
      <table class="form-layout-compressed">
          <tr class="crm-option_group-form-block-name"><td class="label">{$form.name.label}</td><td>{$form.name.html}</td></tr>
          <tr class="crm-option_group-form-block-description"><td class="label">{$form.description.label} 
          ...
          <tr class="crm-option_group-form-block-is_active"><td class="label">{$form.is_active.label}</td><td>{$form.is_active.html}</td></tr>
      </table>
     {/if}   
