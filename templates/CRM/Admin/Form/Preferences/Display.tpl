 ...
 <div class="crm-submit-buttons">{include file="CRM/common/formButtons.tpl" location="top"}</div>
     <table class="form-layout">
	    ...
	    <tr class="crm-preferences-form-block-contact_view_options">
            ...
            <tr class="crm-preferences-form-block-description">
               <td>&nbsp;</td>
	...
	{if $form.contact_edit_options.html}        		       
	    <tr class="crm-preferences-form-block-contact_edit_options">
	...
	{if $form.advanced_search_options.html}
            <tr class="crm-preferences-form-block-advanced_search_options">
	...
	{if $form.user_dashboard_options.html}
            <tr class="crm-preferences-form-block-user_dashboard_options">
	...
	{if $form.wysiwyg_editor.html}
            <tr class="crm-preferences-form-block-wysiwyg_editor">
	...
	{if $form.display_name_format.html}
            <tr class="crm-preferences-form-block-display_name_format" >
	...
	{if $form.sort_name_format.html}
            <tr class="crm-preferences-form-block-sort_name_format">
