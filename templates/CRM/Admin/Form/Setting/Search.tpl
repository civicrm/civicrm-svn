...
<fieldset><legend>{ts}Contact Search{/ts}</legend>
    <table class="form-layout">
        ...
        <tr class="crm-searchSetting-form-block-includeEmailInName">
        ...
        <tr  class="crm-searchSetting-form-block-includeNickNameInName">
        ...
        <tr class="crm-searchSetting-form-block-includeAlphabeticalPager" >
        ...
        <tr class="crm-searchSetting-form-block-includeOrderByClause">
        ...
        <tr class="crm-searchSetting-form-block-defaultSearchProfileID">
        ...
        <tr class="crm-searchSetting-form-block-smartGroupCacheTimeout">
        ...
        <tr class="crm-searchSetting-form-block-autocompleteContactSearch">
