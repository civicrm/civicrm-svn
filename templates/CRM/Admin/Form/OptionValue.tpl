...
<div class="crm-block crm-form-block crm-option-value-form-block">
   ...
   {if $action eq 8}
     ...
     {else}    
      <table class="form-layout-compressed">
        <tr class="crm-option-value-form-block-label">
        ...
        <tr class="crm-option-value-form-block-value">
        ...
        <tr class="crm-option-value-form-block-name">   
            <td class="label">{$form.name.label}</td>
            <td>{$form.name.html}</td>
        </tr>
        <tr class="crm-option-value-form-block-grouping">
            <td class="label">{$form.grouping.label}</td>
            <td>{$form.grouping.html}</td>
        </tr>
        <tr class="crm-option-value-form-block-description">
            <td class="label">{$form.description.label}</td>
            <td>{$form.description.html}</td>
        </tr>
        <tr class="crm-option-value-form-block-weight">
            <td class="label">{$form.weight.label}</td>
            <td>{$form.weight.html}</td>
        </tr>
        {if $form.is_default}
        <tr class="crm-option-value-form-block-is_default">
            <td class="label">{$form.is_default.label}</td>
            <td>{$form.is_default.html}</td>
        </tr>
        {/if}
        <tr class="crm-option-value-form-block-is_active">
            <td class="label">{$form.is_active.label}</td>
            <td>{$form.is_active.html}</td>
        </tr>
        <tr class="crm-option-value-form-block-is_optgroup">
       ...
       {if $form.contactOptions}{* contactOptions is exposed for email/postal greeting and addressee types to set filter for contact types *}
        <tr class="crm-option-value-form-block-contactOptions">
