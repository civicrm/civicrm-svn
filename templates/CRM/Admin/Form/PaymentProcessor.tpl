...
{else}
  <table class="form-layout-compressed">
	...
	{ts 1=$ftUrl}There is no Financial Type configured of 'Is Asset Account of'. <a href='%1'>Click here</a> if you want to configure financial types for your site.{/ts}
    </tr>
    {/if}
    </td>
