    	        ...
    	        <div class="ac_results" id="crm-contribpage-links-list">
    	      	   <div class="crm-contribpage-links-list-inner">
    	      	   	<ul>
                            ...
                            <li><a class="crm-contribution-test" href="{crmURL p='civicrm/contribute/transact' q="reset=1&action=preview&id=`$contribPageId`"}">{ts}Online Contribution (Test-drive){/ts}</a></li>
                            <li><a class="crm-contribution-live" href="{crmURL p='civicrm/contribute/transact' q="reset=1&id=`$contribPageId`"}" target="_blank">{ts}Online Contribution (Live){/ts}</a></li>
    		        </ul>
    	           </div>
    	      </div>
        </div></li>
