...
<div class="form-item">
	...
	<tr class="crm-contribution-form-block-title"><td class="label">{$form.title.label} {if $action == 2}{include file='CRM/Core/I18n/Dialog.tpl' table='civicrm_contribution_page' field='title' id=$id}{/if}</td><td>{$form.title.html}<br/>
	...
	<tr class="crm-contribution-form-block-contribution_type_id"><td class="label">{$form.contribution_type_id.label}</td><td>{$form.contribution_type_id.html}<br />	
	...
	<tr class="crm-contribution-form-block-is_organization"><td>&nbsp;</td><td>{$form.is_organization.html} {$form.is_organization.label}</td></tr>
	<tr id="for_org_option" class="crm-contribution-form-block-is_organization">
        <td>&nbsp;</td>
        <td>
            <table class="form-layout-compressed">
            <tr id="for_org_text" class="crm-contribution-form-block-for_organization">
            ...
            <tr class="crm-contribution-form-block-is_for_organization">
                <td>&nbsp;</td>
	...
	<tr class="crm-contribution-form-block-intro_text"><td class ="label">{$form.intro_text.label}</td><td>{$form.intro_text.html}<br />
	...
	<tr class="crm-contribution-form-block-footer_text"><td class ="label">{$form.footer_text.label}</td><td>{$form.footer_text.html}<br />
	...
	<tr class="crm-contribution-form-block-goal_amount"><td class ="label">{$form.goal_amount.label}</td><td>{$form.goal_amount.html}<br />
	...
	<tr class="crm-contribution-form-block-start_date">
	    <td class ="label">{$form.start_date.label}</td>
	    <td>
	        {include file="CRM/common/jcalendar.tpl" elementName=start_date}
	    </td>    
    </tr>
	<tr class="crm-contribution-form-block-end_date">
	    <td class ="label">{$form.end_date.label}</td>
	    <td>
	        {include file="CRM/common/jcalendar.tpl" elementName=end_date}
	    </td>    
    </tr>
	<tr class="crm-contribution-form-block-honor_block_is_active"><td>&nbsp;</td><td>{$form.honor_block_is_active.html}{$form.honor_block_is_active.label}<br />
...
<table class="form-layout-compressed" id="honor">
    	<tr class="crm-contribution-form-block-honor_block_title"><td class="label">{$form.honor_block_title.label} {if $action == 2}{include file='CRM/Core/I18n/Dialog.tpl' table='civicrm_contribution_page' field='honor_block_title' id=$id}{/if}</td><td>{$form.honor_block_title.html}<br />
	    <span class="description">{ts}Title for the Honoree section (e.g. &quot;Honoree Information&quot;).{/ts}</span></td>
	</tr>
	<tr class="crm-contribution-form-block-honor_block_text">
...
<table class="form-layout-compressed">
		<tr class="crm-contribution-form-block-is_active"><td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td><td>{$form.is_active.html} {$form.is_active.label}<br />
	{if $id}
