...
<table class="selector">
  ...
  <tr id='rowid{$row.contribution_id} crm-contribution_{$row.contribution_id}' class="{cycle values="odd-row,even-row"}{if $row.cancel_date} disabled{/if} crm-contribution">
    {if !$single }
        {if $context eq 'Search' }       
