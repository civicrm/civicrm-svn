...
<table>
    ...
    <tr class="crm-report-form-block-report_header">
    ...
    <tr class="crm-report-form-block-report_footer">
...
<table>
    <tr class="crm-report-form-block-is_navigation">
    ...
    <tr class="crm-report-form-block-parent_id" id="navigation_menu">
    ...
    {if $config->userFramework neq 'Joomla'}
        <tr class="crm-report-form-block-permission">
    ...
    {/if}
    <tr class="crm-report-form-block-addToDashboard">
