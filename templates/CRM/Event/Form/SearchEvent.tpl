{*
 ...
 +--------------------------------------------------------------------+
*}
<div class="crm-block crm-form-block crm-search_event-form-block">
 <h3>{ts}Find Events{/ts}</h3>
  <table class="form-layout">
    <tr class="crm-search_event-form-block-title">
    ...
    <tr>
       ...
       <table class="form-layout-compressed" id="id_fromToDates">
        <tr class="crm-search_event-form-block-start_date">
            <td class="label">{$form.start_date.label}</td>
            <td>{include file="CRM/common/jcalendar.tpl" elementName=start_date}</td>
        </tr>
        <tr class="crm-search_event-form-block-end_date">
