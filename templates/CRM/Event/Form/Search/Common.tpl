...
<tr>
    <td class="crm-event-form-block-participant_test">{$form.participant_test.label} {help id="is-test" file="CRM/Contact/Form/Search/Advanced"} &nbsp; {$form.participant_test.html}<span class="crm-clear-link">(<a href="javascript:unselectRadio('participant_test','{$form.formName}')">{ts}clear{/ts}</a>)</span></td>
