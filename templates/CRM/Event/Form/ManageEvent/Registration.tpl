...
<div class="form-item">
	...
	<table class="form-layout-compressed">
        ...
        <tr class="crm-event-form-block-registration_link_text">
       ...
       {if !$isTemplate}
        <tr class="crm-event-form-block-registration_start_date">  
        ...
        <tr class="crm-event-form-block-registration_end_date">
       ...
       {/if}
        <tr class="crm-event-form-block-is_multiple_registrations">
        ...
        <tr class="crm-event-form-block-allow_same_participant_emails">
        ...
        <tr class="crm-event-form-block-requires_approval">
        ...
        <tr id="id-approval-text" class="crm-event-form-block-approval_req_text">
        ...
        <tr class="crm-event-form-block-expiration_time">
    ...
    <div id="registration">
        ...
        <table class= "form-layout-compressed">
         <tr class="crm-event-form-block-intro_text">
         ...
         <tr class="crm-event-form-block-footer_text">
         ...
         <tr class="crm-event-form-block-custom_pre_id">
         ...
         <tr class="crm-event-form-block-custom_post_id">
         </tr>
        ...
        <tr id="additional_profile_pre" class="crm-event-form-block-additional_custom_pre_id">
        ...
        <tr id="additional_profile_post" class="crm-event-form-block-additional_custom_post_id">
        ...
        <fieldset><legend><a href="#" onclick="hide('confirm'); show('confirm_show'); return false;"><img src="{$config->resourceBase}i/TreeMinus.gif" class="action-icon" alt="{ts}close section{/ts}"/></a>{ts}Confirmation Screen{/ts}</legend>
         <table class= "form-layout-compressed">
           <tr class="crm-event-form-block-confirm_title">
           ...
           <tr class="crm-event-form-block-confirm_text">
           ...
           <tr class="crm-event-form-block-confirm_footer_text">
        ...
        <fieldset><legend><a href="#" onclick="hide('thankyou'); show('thankyou_show'); return false;"><img src="{$config->resourceBase}i/TreeMinus.gif" class="action-icon" alt="{ts}close section{/ts}"/></a>{ts}Thank-you Screen{/ts}</legend>
         <table class= "form-layout-compressed">
           <tr class="crm-event-form-block-confirm_thankyou_title">           
            ...
            <tr class="crm-event-form-block-confirm_thankyou_text">
            ...
            <tr class="crm-event-form-block-confirm_thankyou_footer_text">
        ...
        <fieldset><legend><a href="#" onclick="hide('mail'); show('mail_show'); return false;"><img src="{$config->resourceBase}i/TreeMinus.gif" class="action-icon" alt="{ts}close section{/ts}"/></a>{ts}Confirmation Email{/ts}</legend>
          <table class= "form-layout-compressed">
            <tr class="crm-event-form-block-is_email_confirm"> 
          ...
          <div id="confirmEmail">
           <table class="form-layout-compressed">
             <tr class="crm-event-form-block-confirm_email_text">
             ...
             <tr class="crm-event-form-block-confirm_from_name">
             ...
             <tr class="crm-event-form-block-confirm_from_email">
             ...
             <tr class="crm-event-form-block-cc_confirm">
