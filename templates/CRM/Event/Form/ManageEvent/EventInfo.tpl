...
{else} 
	...
	<table class="form-layout-compressed">
		...
		{/if}
		<tr class="crm-event-form-block-event_type_id">
		...
		<tr class="crm-event-form-block-default_role_id">
		...
		<tr class="crm-event-form-block-participant_listing_id">
		...
		<tr class="crm-event-form-block-summary">
		...
		<tr class="crm-event-form-block-description">
			<td class="label">{$form.description.label}</td>
			<td>{$form.description.html}</td>
		</tr>
		{if !$isTemplate}
			<tr class="crm-event-form-block-start_date">
				<td class="label">{$form.start_date.label}</td>
				<td>{include file="CRM/common/jcalendar.tpl" elementName=start_date}</td>
			</tr>
			<tr class="crm-event-form-block-end_date">
				<td class="label">{$form.end_date.label}</td>
				<td>{include file="CRM/common/jcalendar.tpl" elementName=end_date}</td>
			</tr>
		{/if}
		<tr class="crm-event-form-block-max_participants">
    ...
    <tr id="id-waitlist" class="crm-event-form-block-has_waitlist">
      {if $form.has_waitlist}
        <td class="label">{$form.has_waitlist.label}</td>
        <td>{$form.has_waitlist.html} {help id="id-has_waitlist"}</td>
      {/if}
    </tr>
		<tr id="id-event_full" class="crm-event-form-block-event_full_text">
		...
		<tr id="id-waitlist-text" class="crm-event-form-block-waitlist_text">
