...
{/if}
<div class="crm-block crm-form-block crm-manage_event_info-form-block">
{if $cdType} 
...
{else} 
	...
	<table class="form-layout-compressed">
		...
		{/if}
		<tr class="crm-manage_event_info-form-block-event_type_id">
		...
		<tr class="crm-manage_event_info-form-block-default_role_id">
		...
		<tr class="crm-manage_event_info-form-block-participant_listing_id">
		...
		<tr class="crm-manage_event_info-form-block-title">
		...
		<tr class="crm-manage_event_info-form-block-summary">
		...
		<tr class="crm-manage_event_info-form-block-description">
			<td class="label">{$form.description.label}</td>
			<td>{$form.description.html}</td>
		</tr>
		{if !$isTemplate}
			<tr class="crm-manage_event_info-form-block-start_date">
		...
		{/if}
		<tr class="crm-manage_event_info-form-block-max_participants">
    ...
    <tr id="id-waitlist" class="crm-manage_event_info-form-block-has_waitlist">
      {if $form.has_waitlist}
        <td class="label">{$form.has_waitlist.label}</td>
        <td>{$form.has_waitlist.html} {help id="id-has_waitlist"}</td>
      {/if}
    </tr>
		<tr id="id-event_full" class="crm-manage_event_info-form-block-event_full_text">
		...
		<tr id="id-waitlist-text" class="crm-manage_event_info-form-block-waitlist_text">
