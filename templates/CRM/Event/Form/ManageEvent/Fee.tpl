...
{capture assign="adminPriceSets"}{crmURL p='civicrm/admin/price' q="reset=1"}{/capture}
    ...
    {/if}
<div class="crm-block crm-form-block crm-manage_event_fee-form-block">
<div class="crm-submit-buttons">
   {include file="CRM/common/formButtons.tpl" location="top"}
</div>

    <table class="form-layout">
       <tr class="crm-manage_event_fee-form-block-title">
	  <td class="label">{$form.title.label}</td>
	  <td>{$form.title.html}</td>
       </tr>	
       <tr class="crm-manage_event_fee-form-block-is_monetary">
    ...
    <table class="form-layout"> 
        {if $paymentProcessor}
         <div id="paymentProcessor">
             <tr class="crm-manage_event_fee-form-block-payment_processor_id">            
        ...
        <div id="contributionType">
            <tr class="crm-manage_event_fee-form-block-contribution_type_id">
            ...
            <tr class="crm-manage_event_fee-form-block-fee_label">
      ...
      <table id="payLater" class="form-layout">
          <tr class="crm-manage_event_fee-form-block-is_pay_later">
      ...
      <table id="payLaterOptions" class="form-layout">
          <tr class="crm-manage_event_fee-form-block-pay_later_text">
          ...
          <tr class="crm-manage_event_fee-form-block-pay_later_receipt">
      ...
      <table id="priceSet" class="form-layout">
            <tr class="crm-manage_event_fee-form-block-price_set_id">
        ...
        {section name=loop start=1 loop=11}
           ...
           <tr><td class="even-row crm-manage_event_fee-form-block-label_{$idx}">{$form.label.$idx.html}</td><td class="crm-manage_event-form-block-value_{$idx}">{$form.value.$idx.html|crmMoney}</td><td class="even-row crm-manage_event-form-block-default_{$idx}">{$form.default.$idx.html}</td></tr>
        {/section}
        </table>
        </fieldset>
    ...
    <div id="isDiscount">
         <table class="form-layout">
             <tr class="crm-manage_event_fee-form-block-is_discount">
	...
	{section name=rowLoop start=1 loop=6}
	   ...
	   <tr id="discount_{$index}" class=" crm-manage_event_fee-form-block-discount_{$index} {if $index GT 1 AND empty( $form.discount_name[$index].value) } hiddenElement {/if} form-item {cycle values="odd-row,even-row"}">
           ...
           <td class="crm-manage_event_fee-form-block-discount_name"> {$form.discount_name.$index.html}</td>
           <td class="crm-manage_event_fee-form-block-discount_start_date"> {include file="CRM/common/jcalendar.tpl" elementName='discount_start_date' elementIndex=$index} </td>
           <td class="crm-manage_event_fee-form-block-discount_end_date"> {include file="CRM/common/jcalendar.tpl" elementName='discount_end_date' elementIndex=$index} </td>
	   </tr>
    {/section}
    </table>
