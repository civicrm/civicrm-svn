...
<div class="crm-block crm-form-block crm-membership_type-form-block">
...
<div class="form-item" id="membership_type_form">
   ...
   <table class="form-layout-compressed">
      <tr class="crm-membership_type-form-block-name">
      ...
      <tr class="crm-membership_type-form-block-description">
      ...
      <tr class="crm-membership_type-form-block-member_org">
     ...
     {/if} {* end if searchDone *}
      ...
      <table class="form-layout-compressed">
         <tr class="crm-membership_type-form-block-minimum_fee">
         ...
         <tr class="crm-membership_type-form-block-contribution_type_id">
         ...
         <tr class="crm-membership_type-form-block-duration_unit_interval">        
         ...
         <tr class="crm-membership_type-form-block-period_type"> 
         ...
         <div id="fixed_period">
         <tr class="crm-membership_type-form-block-fixed_period_start_day">
         ...
         <tr class="crm-membership_type-form-block-fixed_period_rollover_day">
       ...
       <div class="spacer"></div>	    
         <tr class="crm-membership_type-form-block-relationship_type_id"> 	
         ...
         <tr class="crm-membership_type-form-block-visibility">
         ...
         <tr class="crm-membership_type-form-block-weight">
             <td class="label">{$form.weight.label}</td>
             <td>{$form.weight.html}</td>
         </tr>
         <tr class="crm-membership_type-form-block-is_active">
        ...
        {else}
            <table class="form-layout-compressed">
                <tr class="crm-membership_type-form-block-renewal_msg_id" >
                ...
                <tr class="crm-membership_type-form-block-renewal_reminder_day">              
