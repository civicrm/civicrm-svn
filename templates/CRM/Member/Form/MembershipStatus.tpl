...
<div class="crm-block crm-form-block crm-membership_status-form-block" id=membership_status>
 ...
 <div class="crm-submit-buttons">{include file="CRM/common/formButtons.tpl" location="top"}</div>
   ...
   {else}
    <table class="form-layout-compressed">
     <tr class="crm-membership_status-form-block-name">
	<td class="label">{$form.name.label}</td>
      ...
      <tr class="crm-membership_status-form-block-start_event">
      ...
      <tr class="crm-membership_status-form-block-start_event_unit_interval">
      ...
      <tr class="crm-membership_status-form-block-end_event">
      ...
      <tr class="crm-membership_status-form-block-end_event_unit_interval">
      ...
      <tr class="crm-membership_status-form-block-is_current_member">
      ...
      <tr class="crm-membership_status-form-block-is_admin">
      ...
      <tr class="crm-membership_status-form-block-weight">
      ...
      <tr class="crm-membership_status-form-block-is_default">
      ...
      <tr class="crm-membership_status-form-block-is_active">
