...
<fieldset><legend>{if $action eq 1}{ts}New Membership Status{/ts}{elseif $action eq 2}{ts}Edit Membership Status{/ts}{else}{ts}Delete Membership Status{/ts}{/if}</legend>
   ...
   {else}
	...
	<td class="label">{$form.name.label}</td>
      ...
      <tr class="crm-membership-form-block-start_event">
      ...
      <tr class="crm-membership-form-block-start_event_unit_interval">
      ...
      <tr class="crm-membership-form-block-end_event">
      ...
      <tr class="crm-membership-form-block-end_event_unit_interval">
      ...
      <tr class="crm-membership-form-block-is_current_member">
      ...
      <tr class="crm-membership-form-block-is_admin">
      ...
      <tr class="crm-membership-form-block-is_default">
