 ...
 <fieldset>
   <table class="form-layout">
      <div id="upload-file" class="form-item">
       <tr class="crm-membership-from-block-uploadFile">
       ...
       <tr class="crm-membership-from-block-skipColumnHeader">
       ...
       <tr class="crm-membership-from-block-contactType">
       ...
       <tr class="crm-membership-from-block-onDuplicate">
           <td class="label" >{$form.onDuplicate.label}</td>
           <td>{$form.onDuplicate.html} {help id="id-onDuplicate"}</td>
       </tr>
       <tr class="crm-membership-from-block-date">{include file="CRM/Core/Date.tpl"}</tr>  
{if $savedMapping}
       <tr  class="crm-membership-from-block-savedMapping">
...
</table></fieldset><div class="spacer"></div>
<table>
<tr>
