 ...
 */
define( 'CIVICRM_UF_DSN'           , 'mysql://root:@localhost/civicrm_tests_dev?new_link=true' );
 ...
 *
 */
define( 'CIVICRM_DSN'          , 'mysql://root:@localhost/civicrm_tests_dev?new_link=true' );
...
$civicrm_root = 'C:/utils/eclipseworkspace/api-civicrm';
define( 'CIVICRM_TEMPLATE_COMPILEDIR', 'C://webroot/sites/api/files' );
