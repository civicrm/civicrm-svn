...
<fieldset><legend>{if $action eq 1}{ts}New Mailing Component{/ts}{else}{ts}Edit Mailing Component{/ts}{/if}</legend>
  <table class="form-layout">
    ...
    <tr class="crm-mailing-form-block-component_type"><td class="label">{$form.component_type.label}</td><td>{$form.component_type.html}</td>
    <tr class="crm-mailing-form-block-subject"><td class="label">{$form.subject.label}</td><td>{$form.subject.html}</td>
    <tr class="crm-mailing-form-block-body_text"><td class="label">{$form.body_text.label}</td><td>{$form.body_text.html}</td>
