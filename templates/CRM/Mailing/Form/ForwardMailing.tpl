...
<tr><td class="label" >{$form.email_0.label}</td><td>{$form.email_0.html}</td></tr>
<tr><td class="label" >{$form.email_1.label}</td><td>{$form.email_1.html}</td></tr>
<tr><td class="label" >{$form.email_2.label}</td><td>{$form.email_2.html}</td></tr>
<tr><td class="label" >{$form.email_3.label}</td><td>{$form.email_3.html}</td></tr>
<tr><td class="label" >{$form.email_4.label}</td><td>{$form.email_4.html}</td></tr>
...
<div id="comment" style="display:none">
            <table class="form-layout">
            <tr class="crm-mailing-form-block-forward_comment"><td><a href="#" onclick="hide('comment'); show('comment_show'); return false;"><img src="{$config->resourceBase}i/TreeMinus.gif" class="action-icon" alt="{ts}close section{/ts}"/></a></a>
