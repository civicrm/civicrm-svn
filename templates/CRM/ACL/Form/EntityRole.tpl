...
<div class="crm-block crm-form-block crm-acl_entity_role-form-block">
...
{else}
    <table class="form-layout-compressed">
      <tr class="crm-acl_entity_role-form-block-acl_role_id">
      ...
      <tr class="crm-acl_entity_role-form-block-entity_id">
      ...
      <tr class="crm-acl_entity_role-form-block-is_active">
