...
SPL{$tabchar}{$spl.spl_id}{$tabchar}GENERAL JOURNAL{$tabchar}{$spl.trxn_date}{$tabchar}{$spl.account_name}{$tabchar}{$spl.contact_name}{$tabchar}{$tabchar}{$spl.amount}{$tabchar}{$spl.check_date}{$tabchar}{$tabchar}{$spl.payment_instrument}
{/foreach}
ENDTRNS
{/foreach}
{/if}
