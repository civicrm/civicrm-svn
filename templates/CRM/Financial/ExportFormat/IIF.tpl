...
character. (I'm wondering if it's better not to use smarty for this.)
***** IMPORTANT *************

*}
{assign var='tabchar' value=chr(9)}
{if !empty($exportParams['accounts'])}
...
*}
{foreach from=$exportParams.accounts key=account_id item=acct}
