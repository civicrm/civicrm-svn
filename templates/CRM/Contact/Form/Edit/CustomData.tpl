...
{if $cd_edit.is_multiple eq 1}
  ...
  <div></div>
  <div id="{$cd_edit.name|cat:"_$divName"}" class="crm-accordion-wrapper crm-accordion_title-accordion {if $cd_edit.collapse_display and !$skipTitle}collapsed{else}{/if}">
{else}
  <div id="{$cd_edit.name}" class="crm-accordion-wrapper crm-address-accordion {if $cd_edit.collapse_display}collapsed{else}{/if}">
{/if}
