...
<div class="crm-submit-buttons">{include file="CRM/common/formButtons.tpl" location="top"}</div>
	...
	<tr id='field_advance_filter'>
	      ...
	      <br />
	      <span class="description">{ts}Filter contact listing using Contact Get API parameters. EXAMPLE: To list Organizations in group 3:{/ts} "action=get&group=3&contact_type=Organization" {docURL page="CiviCRM Public APIs"}</span> 
            </td>
        </tr>
