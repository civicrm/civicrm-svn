...
{/literal}
<div class="crm-block crm-form-block crm-add_custom_field-form-block">
<div class="crm-submit-buttons">{include file="CRM/common/formButtons.tpl" location="top"}</div>
    <table class="form-layout">
        <tr class="crm-add_custom_field-form-block-label">
        ...
        <tr class="crm-add_custom_field-form-block-data_type">
        ...
        <tr class="crm-add_custom_field-form-block-text_length"  id="textLength" {if !( $action eq 1 || $action eq 2 ) && ($form.data_type.value.0.0 != 0)}class="hide-block"{/if}>
        ...
        <tr  class="crm-add_custom_field-form-block-options_per_line" id="optionsPerLine" {if $action neq 2 && ($form.data_type.value.0.0 >= 4 && $form.data_type.value.1.0 neq 'CheckBox' || $form.data_type.value.1.0 neq 'Radio' )}class="hide-block"{/if}>
            <td class="label">{$form.options_per_line.label}</td>	
            <td class="html-adjust">{$form.options_per_line.html|crmReplace:class:two}</td>
        </tr>
	    <tr  class="crm-add_custom_field-form-block-start_date_years" id="startDateRange" {if $action neq 2 && ($form.data_type.value.0.0 != 5)}class="hide-block"{/if}>
        ...
        <tr class="crm-add_custom_field-form-block-end_date_years" id="endDateRange" {if $action neq 2 && ($form.data_type.value.0.0 != 5)}class="hide-block"{/if}>
        ...
        <tr  class="crm-add_custom_field-form-block-date_format"  id="includedDatePart" {if $action neq 2 && ($form.data_type.value.0.0 != 5)}class="hide-block"{/if}>
        ...
        <tr  class="crm-add_custom_field-form-block-note_rows"  id="noteRows" {if $action neq 2 && ($form.data_type.value.0.0 != 4)}class="hide-block"{/if}>
            <td class="label">{$form.note_rows.label}</td>
            <td class="html-adjust">{$form.note_rows.html}</td> 
        </tr>
	    <tr class="crm-add_custom_field-form-block-note_columns" id="noteColumns" {if $action neq 2 && ($form.data_type.value.0.0 != 4)}class="hide-block"{/if}>
            <td class="label">{$form.note_columns.label}</td>
            <td class="html-adjust">{$form.note_columns.html}</td>
        </tr>
        <tr class="crm-add_custom_field-form-block-weight" >
        ...
        <tr class="crm-add_custom_field-form-block-default_value" id="hideDefault" {if $action eq 2 && ($form.data_type.value.0.0 < 4 && $form.data_type.value.1.0 NEQ 'Text')}class="hide-block"{/if}>
        ...
        <tr  class="crm-add_custom_field-form-block-description"  id="hideDesc" {if $action neq 4 && $action eq 2 && ($form.data_type.value.0.0 < 4 && $form.data_type.value.1.0 NEQ 'Text')}class="hide-block"{/if}>
        ...
        <tr class="crm-add_custom_field-form-block-help_pre">
        ...
        <tr class="crm-add_custom_field-form-block-help_post">
        ...
        <tr class="crm-add_custom_field-form-block-is_required">
            <td class="label">{$form.is_required.label}</td>
            <td class="html-adjust">{$form.is_required.html}</td>
        </tr>
        <tr id ="searchable" class="crm-add_custom_field-form-block-is_searchable">
        ...
        <tr id="searchByRange" class="crm-add_custom_field-form-block-is_search_range">
	    <td class="label">{$form.is_search_range.label}</td>
            <td class="html-adjust">{$form.is_search_range.html}</td>
        </tr>
        <tr class="crm-add_custom_field-form-block-is_active">
            <td class="label">{$form.is_active.label}</td>
            <td class="html-adjust">{$form.is_active.html}</td>
        </tr>    
        <tr class="crm-add_custom_field-form-block-is_view">
