...
<div class="crm-accordion-wrapper crm-accordion_title-accordion crm-accordion-closed">
 <div class="crm-accordion-header">
  ...
  <div class="crm-block crm-form-block crm-uf_advance_setting-form-block">
    <table class="form-layout">
        <tr class="crm-uf_advance_setting-form-block-group">
            <td class="label">{$form.group.label}</td>
            <td>{$form.group.html} {help id='id-limit_group' file="CRM/UF/Form/Group.hlp"}</td>
        </tr>

        <tr class="crm-uf_advance_setting-form-block-add_contact_to_group">
        ...
        <tr class="crm-uf_advance_setting-form-block-is_proximity_search">
