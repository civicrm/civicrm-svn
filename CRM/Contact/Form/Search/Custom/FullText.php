...
";   
        ...
        case 'Contribution':
            $sql = "
INSERT INTO {$this->_tableName}
( table_name, contact_id, sort_name, contribution_id, financial_account, contribution_page, contribution_receive_date, 
...
LEFT JOIN  civicrm_financial_account cct ON cct.id = cc.contribution_type_id
