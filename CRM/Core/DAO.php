...
class CRM_Core_DAO extends DB_DataObject {
  ...
  CONST NOT_NULL = 1, IS_NULL = 2, DB_DAO_NOTNULL = 128, VALUE_SEPARATOR = "", BULK_INSERT_COUNT = 200, BULK_INSERT_HIGH_COUNT = 200,
...
";
  ...
  // CRM-9716
  static
  function triggerRebuild($tableName = NULL) {
    $info = array();
