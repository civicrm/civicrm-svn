...
WHERE  ce.loc_block_id = $locBlockId";
     ...
     * @static
     */
    static function getFromEmailIds( $eventId ) 
    {
        ...
        if ( $eventId ) {
            ...
            $returnProperties = array( 'confirm_from_name', 'confirm_from_email' );
        ...
        foreach ( $fromEmailIds as $key => $value ) {
            $emailIds[] = $value;
        }
       
        return array( 'name'  => $emailIds, 
                      'label' => $emailValues ) ;
    }
}
