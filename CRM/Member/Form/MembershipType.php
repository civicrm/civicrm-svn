    ...
    public function postProcess() 
    {
        if ( $this->_action & CRM_Core_Action::DELETE ) {
            ...
            if( CRM_Utils_Array::value( 'contact_check', $submitted ) ){
                ...
                $fieldName = CRM_Core_DAO::getFieldValue( 'CRM_Member_DAO_MembershipType', $membershipType->id, 'member_of_contact_id' );
            }
                
            $optionsIds = null;
            $fieldParams = array( 'price_set_id ' => $priceSetId,
                                  'name'          => $fieldName );
            $results = array( );
            ...
            if( empty( $results ) ){
                ...
                $fieldID = $results['id'];
                $fieldValueParams = array( 'price_field_id'     => $fieldID,
                ...
                if( !empty( $results ) ){
                    ...
                    $results = array( 'price_field_id'     => $fieldID,
                                      'name'               => $submitted['name'],
