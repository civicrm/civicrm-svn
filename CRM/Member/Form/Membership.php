...
WHERE   id IN ( '. implode( ' , ', array_keys( $membershipType ) ) .' )';  
    ...
    public function postProcess() 
    {
        ...
        if ( CRM_Utils_Array::value( 'record_contribution', $formValues ) ) {
            $recordContribution = array( 'total_amount', 'financial_account_id', 'payment_instrument_id', 
       ...
       //exit; 
        ...
        if ( $this->_mode ) {
            ...
            if ( $priceSetId ) {
                $params['financial_account_id'] = CRM_Core_DAO::getFieldValue( 'CRM_Price_DAO_Set',
                                                                               $priceSetId,
