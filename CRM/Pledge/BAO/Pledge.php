...
";
  ...
  function sendAcknowledgment(&$form, $params) {
    ...
    $details = 'Total Amount ' . CRM_Utils_Money::format($params['total_pledge_amount'], $params['currency']) . ' To be paid in ' . $params['installments'] . ' installments of ' . CRM_Utils_Money::format($params['scheduled_amount'], $params['currency']) . ' every ' . $params['frequency_interval'] . ' ' . $params['frequency_unit'] . '(s)';
