...
SELECT civicrm_pledge_payment.id id, scheduled_amount, scheduled_date, reminder_date, reminder_count,
        total_amount, receive_date, civicrm_option_value.name as status, civicrm_option_value.label as status_label, civicrm_contribution.id as contribution_id
...
";
        ...
        while ( $payment->fetch( ) ) {
            ...
            $paymentDetails[$payment->id]['status_label'    ] = $payment->status_label;
