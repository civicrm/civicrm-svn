...
class CRM_Activity_Page_AJAX {
  ...
  function getCaseGlobalRelationships() {
    ...
    $relGlobal = CRM_Case_BAO_Case::getGlobalContacts($globalGroupInfo, $sortSQL, $showLinks = true);
    
    $iFilteredTotal = $iTotal = $params['total'] = count($relGlobal);
  ...
  function getCaseClientRelationships() {
    ...
    $sortMapper = array(
     ...
     $iFilteredTotal = $iTotal = $params['total'] = count($clientRelationships);
   ...
   function getCaseRoles() {
     ...
     $iFilteredTotal = $iTotal = $params['total'] = count($caseRelationships);
