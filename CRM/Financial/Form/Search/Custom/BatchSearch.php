...
class CRM_Contribute_Form_Search_Custom_BatchSearch extends    CRM_Contact_Form_Search_Custom_Basic
    ...
    function alterRows( &$row ) {
        ...
        $links = array(
                    ...
                    foreach( $row as $rowKey => $rowValue ){
                        ...
                        $row[$rowKey]['contact_type' ] = 
                        CRM_Contact_BAO_Contact_Utils::getImage( CRM_Utils_Array::value('contact_sub_type',$rowValue) ? 
