...
class CRM_Upgrade_Page_Upgrade extends CRM_Core_Page {
    ...
    function runFinish() {
        ...
        $postUpgradeMessage = file_get_contents($this->get('postUpgradeMessageFile')); // TODO: Use structured message store

        CRM_Upgrade_Form::doFinish(); // This destroys $session, so do it after ge('postUpgradeMessageFile')
